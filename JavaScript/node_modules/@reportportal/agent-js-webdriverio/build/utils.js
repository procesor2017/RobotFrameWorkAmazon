...
const getClientConfig = (options) => {
    const { token, endpoint, launch, project, rerun, rerunOf, skippedIssue, description, attributes, mode, debug, headers, restClientConfig, isLaunchMergeRequired, } = options;
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ token,
        endpoint,
        launch,
        project }, (rerun && { rerun })), (rerunOf && { rerunOf })), (skippedIssue && { skippedIssue })), (description && { description })), (attributes && { attributes })), (mode && { mode })), (debug && { debug })), (headers && { headers })), (restClientConfig && { restClientConfig })), (isLaunchMergeRequired && { isLaunchMergeRequired }));
};
