...
class Reporter extends reporter_1.default {
    constructor(options) {
        ...
        const clientConfig = (0, utils_1.getClientConfig)(options);
    ...
    onTestStart(testStats) {
        ...
        const ancestors = this.storage.getAllSuites();
        const codeRef = (0, utils_1.getCodeRef)(this.testFilePath, name, ancestors);
        const testItemDataRQ = Object.assign({ name, type: constants_1.TYPES.STEP, codeRef }, (this.options.cucumberNestedSteps && { hasStats: false }));
